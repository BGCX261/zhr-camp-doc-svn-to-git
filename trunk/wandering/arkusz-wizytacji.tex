...
\author{\scriptsize wersja 26} % add revision number in place of author
\date{} % no date
...
\hline
\multicolumn{5}{|c|}{\cellcolor[gray]{0.8}\textbf{\category Dokumentacja finansowa i~nie tylko}} \\
\hline
\hline
...
\hline
\problem & \RaggedRight{Porządek i~czystość na obozie} & \emph{Sprawdzić porządek i~czystość w~miejscu zakwaterowania, również w~częściach wspólnych.} & & \tstrut \\
\cline{3-5}
...
\hline
\problem & \RaggedRight{Wyciąg z~kart obozowych} & \emph{Czy kadra posiada wyciąg informacji z~kart obozowych m.~in. o~uczuleniach, przyjmowanych stale lekach itd?} & & \\
\hline
...
\hline
\problem & \RaggedRight{Stan techniczny sprzętu} & \emph{Czy rodzaj i~stan techniczny rowerów, kajaków i~innego wykorzystywanego sprzętu jest odpowiedni?} & & \tstrut \\
\hline
\multicolumn{5}{c}{} \\
\hline
...
\cline{3-5}
 & & \emph{Czy śpiewano hymn harcerski?} & & \\
\cline{3-5}
 & & \emph{Czy była bandera?} & & \\
\cline{3-5}
...
\cline{3-5}
 & & \emph{Jeśli na obozie jest gitara lub inny instrument wykorzystywany podczas ognisk, to w~jaki sposób jest ona transportowana do kolejnego miejsca zakwaterowania? Kto nosi gitarę, czy jest ona przytroczona do plecaka, czy niesiona w ręku?} & & \tstrut \\
\hline
...
\cline{2-2}
\tstrut & \RaggedRight{Drużynowa} & \multicolumn{3}{@{}p{12.7cm}@{}}{} \\
\cline{2-2}
\tstrut & \RaggedRight{Drużynowy} & \multicolumn{3}{@{}p{12.7cm}@{}}{} \\
\cline{2-2}
\tstrut & \RaggedRight{Instruktor programowy} & \multicolumn{3}{@{}p{12.7cm}@{}}{} \\
\cline{2-2}
...
\hline
\problem & \RaggedRight{Służba} & \emph{Czy obóz wykonał jakąkolwiek służbę na rzecz lokalnej społeczności albo pojedynczych osób? Czy służba jest wpisana w~plan pracy obozu?} & & \\
\hline
\problem & \RaggedRight{Pierwsze wrażenie} & \emph{Po czym można poznać na pierwszy rzut oka, że to obóz harcerski a~nie kolonia czy wycieczka klasowa?} & & \tstrut \\
\hline
\problem & \RaggedRight{Atrakcyjność} & \emph{Jest ciekawie czy nudno? Czy obóz można uznać za atrakcyjny, ciekawy?} & & \\
\cline{3-5}
...
\hline
\problem & \RaggedRight{Atmosfera i~samopoczucie} & \emph{Ocenić jak obóz się prezentuje jako taki. Jakie są: atmosfera, odczucia i~nastroje wśród uczestników i~kadry?} & & \\
\cline{3-5}
...
\cline{3-5}
 & & \emph{Jaki cel w~związku z~organizacją obozu postawił sobie komendant (drużynowy) i~w~jakim zakresie udaje mu się go realizować?} & & \tstrut \\
\hline
...
\hline
\problem & \RaggedRight{Harcerskie znajomości} & \emph{Czy podczas wędrówki udało się nawiązać jakieś harcerskie znajomości z~innym środowiskiem?} & & \\
\hline
\problem & \RaggedRight{Punkty GOT, TOK, KOT itp.} & \emph{Czy uczestnicy obozu mają książeczki wycieczek PTTK i~zbierają do nich potwierdzenia pobytu?} & & \\
\hline
\multicolumn{5}{c}{} \\
\hline
...
\hline
\hline
\multicolumn{5}{|p{17cm}|}{\rule[-42pt]{0cm}{140pt}} \\
\hline
\multicolumn{5}{c}{} \\
\hline
...
\hline
\hline
\multicolumn{5}{|p{17cm}|}{\rule[-42pt]{0cm}{88pt}} \\
\hline
\multicolumn{5}{c}{} \\
\multicolumn{5}{@{}p{17cm}@{}}{
\begin{tabular}{|p{8.3cm}|p{8.25cm}|}
\hline
